...
PREFERENCE_SETTINGS = [
    ...
    Setting('setting_display', 'timezone', str,
            ...
            default='Europe/Dublin', ui='select', name='Timezone'),
...
ACCOUNT_SETTINGS = [
    ...
    Setting('setting_info', 'institute', str, range=constant.institute.INSTITUTES,
            ui='select',  name='Institute'),
    Setting('setting_info', 'country', str, range=constant.country.COUNTRIES,
